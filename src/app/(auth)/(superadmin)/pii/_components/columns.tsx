...
export interface UserProfile {
  ...
  country: string;
  address: string;
  role: 'host' | 'guest' | string; // Extend roles as needed
...
export const Columns = (): ColumnDef<UserProfile>[] => [
  ...
  {
    accessorKey: "is_menopause",
    header: "Menopause",
    cell: ({ row }) => (row.getValue("is_menopause") ? "Yes" : "No"),
  },
  {
    accessorKey: "pii_request",
    header: "PII Requested",
    cell: ({ row }) => (row.getValue("pii_request") ? "Yes" : "No"),
  },
];
