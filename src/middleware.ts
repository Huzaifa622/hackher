...
export function middleware(request: NextRequest) {
  ...
  const superadminRoutes = ["/hosts-guests-by-age", "/snacks","/specific-symptoms","/host-stats","/relationship" , "/host-and-guest-by-location","/host-week-summary","/symptom-percentage-all-hosts","/package-management" , "/influencer" , "/deleted-users","/pii","/feedback","/mercury-records"];
